...
import { IconButton, Badge, Input, Button, Typography } from '@material-ui/core'
				...
				{this.state.askForUsername === true ?
					<div style={{
						...
						<div style={{
							...
							<p style={{ margin: 0, fontWeight: "bold", fontSize: '20px', paddingRight: "50px" }}>Set your username</p>
							<Input placeholder="Username" value={this.state.username} onChange={e => this.handleUsername(e)} />
							<Button variant="contained" color="primary" onClick={this.connect} style={{ margin: "20px" }}>Connect</Button>
						</div>
						<div style={{ display: 'flex', justifyContent: "flex-end", textAlign: "center", flex: 3, maxWidth: "100%", overflow: 'hidden', minWidth: '500px' }}>
							<video
								id="my-video"
